...
A) Beginner/tidyverse consolidation: Tackle the exercises in Chapter 3 of Geocomputation with R
...
C) Advanced/raster: Find the sea level rise reprex presented on Monday and build on it:

1. To find the % of Sczecin that would be flooded under a 20m scenario of SLR?
1. What % of Prague area will be flooded by 200m of SLR?!
2. The % of another low-lying town of your choice that would be flooded by a SLR value of your choice.
...
If (really) bored: check out the science of SLR in refs here: https://geocompr.github.io/presentations/geostat18-geocomputation.html#64
