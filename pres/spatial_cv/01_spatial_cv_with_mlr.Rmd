...
**mlr** is a metapackage that lets you combine hundreds of modeling algorithms of many different package within a single framework `r Citep(my_bib, "bischl_mlr:_2016", .opts = list(cite.style = "authoryear"))`
