...
Aim of spatial cross-validation is to find out how generalizable a model is.
...
**mlr** is a metapackage that lets you combine hundreds of modeling algorithms of many different package within a single framework.
...
--
The linear model is slightly better than the random forest model.
...
---
Use pptx background image!!!! Much nicer
<center>
<figure>
<img align="center" src="img/fog_flag_mongon.png", width="200%", height="200%"/>
</figure>
</center>
---
class: small
